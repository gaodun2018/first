import Entry from '../page/Entry.vue';
// 资源列表
...
// 登陆
const Login = resolve => {
    require.ensure(['../page/Login.vue'], (require) => {
...
const UpdatePwd = resolve => {
    require.ensure(['../page/UpdatePwd.vue'], (require) => {
        resolve(require('../page/UpdatePwd.vue'))
    },'UpdatePwd')
}
// 财经云
const Home = resolve => {
    require.ensure(['../page/Home.vue'], (require) => {
...
const EducationalClass = resolve => {
    require.ensure(['../page/EducationalClass.vue'], (require) => {
        resolve(require('../page/EducationalClass.vue'))
    },'EducationalClass')
}
// EP定制标杆计划
const CustomizedPlan = resolve => {
    require.ensure(['../page/CustomizedPlan.vue'], (require) => {
        resolve(require('../page/CustomizedPlan.vue'))
    },'CustomizedPlan')
}
// EP选择标杆计划
const ChoosePlan = resolve => {
    require.ensure(['../page/ChoosePlan.vue'], (require) => {
        resolve(require('../page/ChoosePlan.vue'))
    },'ChoosePlan')
}
// 查看完整计划
const EducationalPlanAll = resolve => {
    require.ensure(['../page/EducationalPlanAll.vue'], (require) => {
        resolve(require('../page/EducationalPlanAll.vue'))
    },'EducationalPlanAll')
}
// 全部学员详情
const EducationalClasslist = resolve => {
    require.ensure(['../page/EducationalClasslist.vue'], (require) => {
        resolve(require('../page/EducationalClasslist.vue'))
