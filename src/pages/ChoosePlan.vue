  ...
  export default {
    ...
    methods: {
      ...
      async getClassList(){
        ...
        // let ret = await this.$http.getClassList(url);
        ...
        let ret = await this.$http.getClassList(this.class_id,{
      ...
      async changeStudentPlan(){
        ...
        let ret = await this.$http.changeStudentPlan(class_id,student_id,plan_id);
        if(ret.data.status == 0){
