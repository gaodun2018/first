                    ...
                    <div class="box-conten">
                        <el-form :model="ruleForm" autoComplete="on" ref="ruleForm" style="text-align: center">
                            ...
                            <span class="container_login">
                                <img src="./../assets/images/login/user-icon.png">
                            </span>
                            ...
                            <span class="container_login">
                                <img style="width: 13px" src="./../assets/images/login/password-icon.png">
                            </span>
...
<style lang="less">
    ...
    .login-left {
        ...
        width: 1342px;
        z-index: 100;
        background: url('./../assets/images/left_bg.jpg') no-repeat center;
    }
    ...
    .login-right {
        ...
        width: 575px;
        z-index: 100;
        background: url('./../assets/images/right_bg.jpg') repeat-x center;
    }
