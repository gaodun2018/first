  ...
  <div class="module-clues-content order-manage">
        ...
        <el-col :sm="24">
          <el-row type="flex" justify="end">
            <div class="input-search">
              <el-input placeholder="讲义ID／讲义名称" size="small" icon="search" v-model="keywords" :on-icon-click="handleIconClick"></el-input>
    ...
    <div class="edu_table">
      <el-table ref="multipleTable" border v-loading="loading" :row-class-name="tableRowClassName" @selection-change="handleSelectionChange" :data="resource.resources" style="width: 100%">
        ...
        <el-table-column prop="partner_id" label="类型" min-width="110">
        </el-table-column>
        ...
        <el-table-column fixed="right" label="操作" align="center" min-width="150">
          <template scope="scope">
            ...
            <el-button type="text"><router-link :to="{path: '/addHandout', query: {id: scope.row.id}}" v-if="unlocking('HANDOUT_EDIT')">修改</router-link></el-button>
            <el-button type="text" v-if="unlocking('HANDOUT_DELETE')" @click="onRemove(scope.row)">删除</el-button>
