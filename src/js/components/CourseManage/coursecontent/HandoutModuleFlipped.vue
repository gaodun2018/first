...
<script>
    ...
    import {deleteCourseHandout,getCourseHandout,AddCourseHandout,updateCourseHandout,SetCourseDisable,GetCourseDisable} from '../../../api/course'
    ...
    export default {
        ...
        methods: {
            ...
            async SetCourseDisable(){
                ...
                let ret = await SetCourseDisable(cource_id,params);
            },
            //获取讲义列表
