                    ...
                    <div class="button_group_b">
                        ...
                        <template v-for="(revs,index) in subjectlist">
                            <span class="clitem" :class="[revs.subject_id === clversm ?'current':'']"
                                  @click="mulchange(revs.subject_id,index)">{{revs.subject_name}}</span>
                        </template>
                    </div>
                </el-col>
            </el-row>
            ...
            <el-form :model="ruleForm" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                ...
                <el-form-item label="所属项目" prop="project_id"
                    ...
                    <el-select v-model="ruleForm.project_id" @change="checkproject" @visible-change="visibleChange"
                               placeholder="请选择所属项目">
                        <el-option v-for="(rev,index) in projectlist" :key="rev.project_name" :label="rev.project_name"
                ...
                <el-form-item label="所属科目" prop="subject_id"
                    ...
                    <el-select v-model="ruleForm.subject_id" :disabled="!issubject" placeholder="请选择所属科目">
                        ...
                        <el-option v-for="(com,index) in boxsubject" :label="com.subject_name"
...
<script>
    import Vue from 'vue';
    import {getProjectSubject, CourseSyllabuses, UpdateCourseSyllabus,CourseSyllabus} from '../../api/outline.js';
