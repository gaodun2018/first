    ...
    <div v-loading="loading">
        ...
        <div class="content-box-show m-middle">
            ...
            <el-row :gutter="20" style="margin-top:20px;">
                <el-col :sm="8" v-for="itm in Agreements" :key="itm.Id">
                    <div class="m-confirm-area m-area">
                        <el-row>
                            <el-col :sm="24" class="m-agree">
                                <span class="m-middle-title sp-agree-title">
                                    <a :href="itm.AgreementUrl" target="_blank" :title="itm.AgreementName"> 《{{itm.AgreementName}}》</a>
                                </span>
                            </el-col>
                        </el-row>
                        <el-row v-if="!itm.IsUserRegier">
                            <el-col :sm="24" class="m-status">
                                ...
                                <el-button type="primary" :disabled="true" size="small" @click="confirmAgree(itm.Id)"
                                           style="width:70px;margin-left:24px;">确认
                                </el-button>
                            </el-col>
                        </el-row>
            ...
            <el-row :gutter="20" style="margin-top:20px;">
                <el-col :sm="8">
                    <div class="m-area m-bottom-fileadd" style="position:relative;">
                        <div style="width:100%;height:100%" v-if="faceShow">
                            <img v-show="IDcardFace" class="m-pic-priview" :src="IDcardFace"/>
                            <el-upload v-show="!IDcardFace" :data="fileFormData" style="height:100%;" ref="uploadface"
                                       :action="materialUpload"
                                       :show-file-list="false" :before-upload="beforeFaceUpload"
                                       :on-success="faceSuccess" :on-change="uploadFaceChange" :auto-upload="false">
                    ...
                    <div style="margin-top:18px;text-align:center;">
                        <el-button type="primary" size="small" style="width:60px;" @click="uploadFile(1)"
                                   v-show="!hasFaceUpload&&orderStatus!=1000427">上传
                        </el-button>
                        ...
                        <el-button v-show="IDcardFace&&orderStatus!=1000427" type="text" size="small" class="m-btn-text"
                                   @click="removeFile(1)" style="border-color: #20a0ff;">删除
                        </el-button>
                    </div>
                </el-col>
                <el-col :sm="8">
                    <div class="m-area" style="position:relative;">
                        <div style="width:100%;height:100%" v-if="backShow">
                            <img class="m-pic-priview" :src="IDcardBack" v-show="IDcardBack"/>
                            <el-upload v-show="!IDcardBack" :data="fileFormData" style="height:100%;" ref="uploadback"
                                       :action="materialUpload"
                                       :show-file-list="false" :on-change="uploadBackChange" :on-success="backSuccess"
                                       :before-upload="beforeFaceUpload" :auto-upload="false">
                                <div class="m-bottom-fileadd" style="width:250px;height:150px;">
                    ...
                    <div style="margin-top:18px;text-align:center;">
                        <el-button type="primary" size="small" style="width:60px;" @click="uploadFile(2)"
                                   v-show="!hasBackUpload&&orderStatus!=1000427">上传
                        </el-button>
                        ...
                        <el-button v-show="IDcardBack&&orderStatus!=1000427" type="text" size="small" class="m-btn-text"
                                   @click="removeFile(2)" style="border-color: #20a0ff;">删除
                        </el-button>
                    </div>
                </el-col>
                <el-col :sm="8">
                    <div :class="[AuditInformationUrl?picClass.dicActive:picClass.dicUnActive,'m-area']"
                         style="position:relative;">
                        <div style="width:100%;height:100%" v-if="zipShow">
                            <el-upload v-show="!AuditInformationUrl" :data="fileFormData" style="height:100%;"
                                       ref="uploadzip" :action="materialUpload"
                                       :show-file-list="false" :on-change="uploadZipChange"
                                       :before-upload="beforeZipUpload" :on-success="zipSuccess" :auto-upload="false">
                            ...
                            <span class="sp-upload-word sp-file-name-overflow"
                                  :title="zipFileName">{{AuditInformationUrl ? zipFileName : '上传其他资料包'}}</span>
                        </div>
                    </div>
                    <div style="margin-top:18px;text-align:center;">
                        <el-button type="primary" size="small" style="width:60px;" @click="uploadFile(3)"
                                   v-show="!hasZipUpload&&orderStatus!=1000427">上传
                        </el-button>
                        <el-button type="primary" size="small" style="width:60px;"
                                   v-show="AuditInformationUrl&&hasZipUpload">
                            <a :href="AuditInformationUrl" target="_blank">
                                下载
                            </a>
                        </el-button>
                        <el-button v-show="AuditInformationUrl&&orderStatus!=1000427" type="text" size="small"
                                   class="m-btn-text" @click="removeFile(3)" style="border-color: #20a0ff;">删除
                        </el-button>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    import {confirmAgreement, removeUploadFile} from '../../api/anonymous';
    import {getOrderInfoByNo} from '../../api/orderPaySerial';
    ...
    export default {
        ...
        methods: {
            ...
            getOrderInfo() {//根据证件号码获取订单信息
                ...
                //this.loading = true;
                getOrderInfoByNo(params).then(ret => {
                    if (ret.status === 0) {
                        let orderInfo = ret.result;
        ...
        mounted() {
            const navigation = document.querySelector('.crm-navigation');
            navigation.classList.add('crm-navigation', 'pointer-events');
        },
    }
</script>