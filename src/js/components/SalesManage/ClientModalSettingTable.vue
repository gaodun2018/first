            ...
            <el-row>
                                ...
                                <el-col>
                                    <div style="margin-left: 40px; padding-top: 10px">
                                        ...
                                        <el-checkbox-group style="display: inline" v-model="ruleForm.settingField">
                                            <el-checkbox style="width: 175px;margin: 0 0 10px 0;" v-for="(item, index) in table" :key="item.field" :label="item.title" v-if="item.field !=='Mobile' && index < 14">{{item.title}}</el-checkbox>
                                        </el-checkbox-group> 
                                    </div>
                                </el-col>
                            </el-row>
                                ...
                                <el-col>
                                    <div>
                                        <el-checkbox-group style="padding: 5px 0 5px 40px;" v-model="ruleForm.settingField">
                                            <el-checkbox style="width: 175px;margin: 0 0 10px 0" v-for="(item, index) in table" :key="item.field" :label="item.title" v-if="item.field!=='field' && index > 13">{{item.title}}</el-checkbox>
                                        </el-checkbox-group>
                                    </div>
                                </el-col>
                            </el-row>
                ...
                <el-col :sm="6">
                    <div class="setting-select" style="margin-right: -10px">
                        <p>当前选定字段</p>
                        <el-row style="height: 348px;overflow: auto">
                            <el-col>
...
// import { myClientTable } from '../common/selesMyClient.js';
...
export default {
    ...
    data() {
        return {
            ...
            custonDate: [],
            ruleForm: {
                settingField: this.self.$store.state.cluesManage.clientTableSetting,
                ruleForm: ''
            },
        }
    },
    methods: {
        ...
        onSeaveTable() { // 保存
            ...
            this.self.$store.dispatch('clientTableSetting', this.ruleForm.settingField);
        },
