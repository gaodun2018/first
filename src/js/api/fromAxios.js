...
//修改班级
export const updateinfoClass = (class_id,params) => put(`${getBaseUrl()}plan-api.gaodun.com/class/${class_id}`, params);
...
export const changeStudentPlan = (class_id,student_id,params) => post(`${getBaseUrl()}plan-api.gaodun.com/class/${class_id}/student/${student_id}/set-plan`,params);//为班级学员设置计划
