            ...
            <div class="chapterbox">
                <template v-if="coursesylllevel == 3">
                    <draggable v-model="tabledata" :options="{group:'firstItem'}" element="div"
                        ...
                        <div v-for="firstItem in tabledata" :key="firstItem.id">
                            <div class="chaptit">
                            ...
                            <draggable v-model="firstItem.children" :options="{group:'secItem'}" element="div">
                                <div v-for="secItem in firstItem.children" :key="secItem.id">
                                    ...
                                    <draggable v-model="secItem.children" :options="{group:'thirdItem'}" element="div">
                                        <div class="resourcebox" v-for="thirdItem in secItem.children"
                                             :key="thirdItem.id">
                                            <div class="knowledge">
                                                <span class="chlft">
                        ...
                        <div v-for="firstItem in tabledata" :key="firstItem.id">
                            ...
                            <draggable v-model="firstItem.children" :options="{group:'secItem'}" element="div">
                                <div v-for="secItem in firstItem.children" :key="secItem.id">
                                    ...
                                    <draggable v-model="secItem.children" :options="{group:'thirdItem'}" element="div">
                                        <div v-for="thirdItem in secItem.children" :key="thirdItem.id">
                                            <div class="knowledge">
                ...
                <template v-if="coursesylllevel == 2">
                    <draggable v-model="tabledata" :options="{group:'firstItem'}" element="div">
                        <div v-for="firstItem in tabledata" :key="firstItem.id">
                            ...
                            <draggable v-model="firstItem.children" :options="{group:'secItem'}" element="div">
                                <div class="resourcebox" v-for="secItem in firstItem.children"
                                     :key="secItem.id">
                                    <div class="knowledge">
                                        <span class="chlft">
    ...
    export default {
        ...
        methods: {
            ...
            async addSyllabusResource() {
                ...
                let res = await  this.$http.checkResIsInOutline(this.coursesyllid, this.resourceRadio);
                if (res.status == 0) {
