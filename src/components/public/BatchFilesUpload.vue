<template>
    <el-dialog class="BatchFilesUpload" :title="title" width="640px" center :visible.sync="dialogUploadVisible">
        <el-row>
            <el-upload class="upload-demo" drag :action="materialUpload" :on-change="handleChange" :on-remove="handleRemove" :on-success="handleAvatarSuccess" :on-error="handleAvatarError" :headers="apiHeader" :before-upload="beforeAvatarUpload" :file-list="fileList">
...
export default {
    ...
    computed: {
        materialUpload() {
            return getBaseUrl() + this.uploadUrl;
        },
        dialogUploadVisible: {
            get: function() {
